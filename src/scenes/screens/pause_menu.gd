...
## input so the paused combat/HUD can't be clicked through. It emits the button intents;
## the run screen owns the actual pause/resume gate, the quit routing and the exit.
...
@onready var _exit_button: Button = $Catcher/Panel/Menu/ExitButton
