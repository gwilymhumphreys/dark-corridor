...
static var HP_BAR_LINE: Color = Color(0.0, 0.0, 0.0, 0.35)      # the faint point lines across a health bar
...
static var UI_PANEL_WEAR: Color = Color8(51, 51, 51)               # panel print wear marks (panel_wear.md)
static var UI_PANEL_WEAR_LIGHT: Color = Color8(123, 120, 120)
