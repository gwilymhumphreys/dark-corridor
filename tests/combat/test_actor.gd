...
func test_starts_at_full_hp() -> void:
  ...
  assert_eq(a.hp, 50, 'starts at max')
  assert_eq(a.max_hp, 50)
...
func test_take_damage_reduces_hp() -> void:
  var a := Actor.new(50.0)
  a.take_damage(20.0)
  assert_eq(a.hp, 30, 'damage with no shield hits HP directly')
...
func test_heal_caps_at_max() -> void:
  ...
  a.take_damage(30.0)
  a.heal(100.0)
  assert_eq(a.hp, 50, 'heal does not exceed max_hp')
...
func test_heal_does_not_revive_the_dead() -> void:
  ...
  a.heal(5.0)
  assert_eq(a.hp, 0, 'heal cannot bring a corpse back above 0')
...
func test_take_damage_returns_the_hp_lost() -> void:
  var a := Actor.new(50.0)
  assert_eq(a.take_damage(20.0), 20, 'no shield: returns the raw amount lost')
...
func test_take_damage_returns_net_after_shield() -> void:
  ...
  assert_eq(dealt, 12, 'shield-absorbed damage is excluded from the return')
  assert_eq(a.hp, 38, 'and only the net reached HP')


func test_take_damage_returns_capped_on_a_killing_blow() -> void:
  var a := Actor.new(10.0)
  var dealt := a.take_damage(25.0)
  assert_eq(dealt, 10, 'a killing blow returns the EFFECTIVE damage, not inflated raw')


func test_take_damage_on_a_corpse_returns_zero() -> void:
  var a := Actor.new(10.0)
  a.take_damage(10.0)
  assert_eq(a.take_damage(5.0), 0, 'a corpse takes no damage')


func test_heal_returns_the_hp_restored() -> void:
  var a := Actor.new(50.0)
  a.take_damage(30.0)
  assert_eq(a.heal(12.0), 12, 'returns the HP actually restored')


func test_heal_returns_post_cap_amount() -> void:
  var a := Actor.new(50.0)
  a.take_damage(5.0)   # at 45 / 50
  assert_eq(a.heal(100.0), 5, 'overheal is excluded: only 5 was restorable')


func test_heal_on_a_corpse_returns_zero() -> void:
  var a := Actor.new(10.0)
  a.take_damage(10.0)
  assert_eq(a.heal(5.0), 0, 'a corpse cannot be healed')
