...
| [systems/tooltips.md](systems/tooltips.md) | The combat item tooltip: hovering a board item opens a main panel and a keyword column beside it, with live values and inline keyword chips. Also the optional pop-up keyword tooltip a chip can carry elsewhere in the interface. |
