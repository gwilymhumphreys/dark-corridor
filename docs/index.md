...
| [systems/debug_panel.md](systems/debug_panel.md) | The dev-only `DebugPanels` autoload: one panel with a preset bar and seven tabs — F1 corridor, F2 interface and palette colours, F3 print, F4 background wear, F5 control feedback, F6 icon slots, F7 cardboard tokens — plus the start-up arguments used for screenshots. |
