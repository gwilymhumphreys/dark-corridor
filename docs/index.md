...
| [systems/testing.md](systems/testing.md) | How tests are written: GUT conventions, the per-area `tests/` folders, the fixture items, character and enemies that keep tests off authored content, `TestCleanup` for resetting autoloads between tests, and signal assertions. |
