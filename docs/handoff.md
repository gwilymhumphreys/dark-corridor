...
> **2026-09-17: mechanics plan steps 1 to 6 are built** — all eight are now
...
> and crit is a chance on an item that doubles that fire's mechanic values. Landing publishes one `APPLIED` event. Still to build:
> the health bar numbers and keyword cards (step 7 of `plans/mechanics.md`).
>
