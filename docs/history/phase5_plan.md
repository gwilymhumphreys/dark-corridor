...
> **A build plan, not a spec.** Sits under [decision_log.md](../decision_log.md) →
...
[`../systems/autotest.md`](../systems/autotest.md). **Next: the deferred content push**
...
[`autotest.md`](../systems/autotest.md) as the "deferred" notes become "built".
