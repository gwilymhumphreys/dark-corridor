...
> ([save](../systems/save.md) · [game_manager](../systems/game_manager.md) ·
> [run_manager](../systems/run_manager.md) · [encounter](../systems/encounter.md) ·
> [draft](../systems/draft.md) · [content](../systems/content.md)); this is the ordered,
> test-first path. Sits under [decision_log.md](../decision_log.md) → *Build order*
